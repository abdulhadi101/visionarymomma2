...
class ColorConstants {
  ...
  static const textColorGrey = Color(0xFFBDBDBD);
  static const primaryColor = Color(0xFF0D014F);
  static const secondaryColor = Color(0xFF6247F1);
  static const thirdColor = Color(0xFF6DEAFC);
  static const backgroundColor = Color(0xFFF6F7FA);
  ...
  static const loadinggray = Color(0x80383065);

  static const textFieldBackground = Color(0xFF000000);
